...
export class PriceCalculatorFor2020 implements ICalculatePrice {
  photographyPrice: number = 1700
  videoRecordingPrice: number = 1700
  bothServicesDiscount: number = 1200
